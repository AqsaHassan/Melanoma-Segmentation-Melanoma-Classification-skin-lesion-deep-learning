...
Original file is located at
    https://colab.research.google.com/drive/1r1hyf4QMAYGbqE6IlPCA6-1Ipy2OhjAE
...
#print("ali accuracy = %f" % (acc_val))
#print("ali loss = %f" % (loss_val))
...
#print("Ali Test accuracy = %f" % acc_test)
#print("Ali loss = %f" % loss_test)
model.save("VGG16.h5")
